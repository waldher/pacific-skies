...
export const CONFIG = {
  ...
  aircraft: { p38: { speedCruise: 275, speedBoost: 370, speedBrake: 165, turnRate: 2.8, gunOffsets: [-3, 3] } },
  generation: { enemyMin: 5, enemyMax: 7, spacing: 1050, jitter: 130, radiusMin: 300, radiusMax: 370 },
  airfield: { deckHeight: 9, length: 300, width: 70, hp: 40, homeHp: 200 },
  progression: { rescueScore: 600, rescueStartRadius: 1200, rescueIntercepts: 2, rescueHp: 140, rescueRadius: 600, rescueRetry: 45, rescueEnemies: 3, rescueSpawnDistance: 1500 },
